...
( function(){
  ...
  for(var i = 0; i<=formData.length;i++) {
      ...
      if(userInfo.type == "textarea") {
         ...
         let selectBoxTag = document.createElement("option")
         selectBoxTag.innerHTML = "Select Language..."
         select.appendChild(selectBoxTag)

         for (let j = 0; j<userInfo.options.length; j++){
           let option = document.createElement("option")
           option.innerHTML = userInfo.options[j].label
